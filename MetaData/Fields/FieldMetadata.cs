...
namespace Atdi.Contracts.CoreServices.EntityOrm.Metadata
{
    ...
    public abstract class FieldMetadata : IFieldMetadata
    {
	    ...
	    protected FieldMetadata(IEntityMetadata entity, IEntityMetadata baseEntity, string name, FieldSourceType sourceType)
        {
            this.Entity = entity;
        ...
        public Type CodeType
        {
	        get
	        {
		        if (_codeType == null)
		        {
			        _codeType = this.Entity.CodeType.GetProperty(this.Name)?.PropertyType;
		        }
