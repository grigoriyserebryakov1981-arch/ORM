...
namespace Atdi.CoreServices.EntityOrm
{
    ...
    public sealed class DataTypeSystem : LoggedObject
    {
        ...
        public DataTypeSystem(ILogger logger) : base(logger)
        {
            ...
            this._adapterTypes[(int)DataType.ClrType][(int)DataSourceVarType.NTEXT] = typeof(ValueAdapters.ClrTypeNTEXT);

            this._adapterTypes[(int)DataType.ClrEnum][(int)DataSourceVarType.INT08] = typeof(ValueAdapters.EnumINT08);
            this._adapterTypes[(int)DataType.ClrEnum][(int)DataSourceVarType.INT32] = typeof(ValueAdapters.EnumINT32);
		}
