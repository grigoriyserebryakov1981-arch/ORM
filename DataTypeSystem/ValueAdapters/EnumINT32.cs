...
{
    class EnumINT32 : ValueAdapter<Enum, int?>
    {
        public EnumINT32(IDataTypeMetadata dataTypeMetadata, ILogger logger) : base(dataTypeMetadata, logger)
        {
        }
        ...
        {
	        return Enum.ToObject(type, ValueReader.ReadAsINT32(dataReader, ordinal));
        }
		...
		public override int? EncodeAs(ColumnValue columnValue)
        {
	        if (columnValue is ClrEnumColumnValue enumSource)
	        {
		        ...
		        return Convert.ToInt32(enumSource.Value);
	        }
