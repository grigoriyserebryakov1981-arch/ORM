...
namespace Atdi.CoreServices.EntityOrm
{
    ...
    {
	    protected ValueAdapter(IDataTypeMetadata dataTypeMetadata, ILogger logger) : base(logger)
        {
		...
		public virtual object DecodeAsType(object storeValue, Type type)
		{
			return this.DecodeAs(storeValue);
		}

		public virtual object DecodeAsType(IEngineDataReader dataReader, int ordinal, Type type)
		{
			return this.DecodeAs(dataReader, ordinal);
		}
